...
class _AppointmentHistoryListState extends State<AppointmentHistoryList> {
  ...
  Future<void> deleteAppointment(String docID) {
    return FirebaseFirestore.instance.collection('appointments').doc(user.email.toString()).collection('all').doc(docID).delete();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('appointments').doc(user.email.toString()).collection('all').orderBy('date', descending: true).snapshots(),
