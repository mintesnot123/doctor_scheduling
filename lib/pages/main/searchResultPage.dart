      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SafeArea(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance.collection('users').where("role", isEqualTo: widget.type).where(widget.filter, isEqualTo: "A" /* widget.searchKey */). /* orderBy('name'). */ snapshots(),
