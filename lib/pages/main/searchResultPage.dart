      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SafeArea(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance.collection('users').where("role", isEqualTo: widget.type).where(/* widget.filter */ "name", isEqualTo: "NAVEEN" /* widget.searchKey */). /* orderBy('name'). */ snapshots(),
