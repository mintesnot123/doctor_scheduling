...
class _DiseaseDetailState extends State<DiseaseDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('disease').orderBy('Name').startAt([
            widget.disease
          ]).endAt([
            widget.disease + '\uf8ff'
          ]).snapshots(),
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: Text(
                              ...
                              style: GoogleFonts.lato(color: Colors.black54, fontSize: 18),
                            )),
                        SizedBox(
                          height: 20,
                        ),
                        Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'How does it spread?',
                                  style: GoogleFonts.lato(color: Colors.black87, fontSize: 20, fontWeight: FontWeight.bold),
